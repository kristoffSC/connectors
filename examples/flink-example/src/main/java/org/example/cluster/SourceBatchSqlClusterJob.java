...
/**
 * SQL batch job that read all records from Delta table and print them in logs/console.
 */
public class SourceBatchSqlClusterJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        tableEnv.toDataStream(table)
            .map(new RowMapperFunction(JobClusterUtils.TEST_ROW_TYPE))
