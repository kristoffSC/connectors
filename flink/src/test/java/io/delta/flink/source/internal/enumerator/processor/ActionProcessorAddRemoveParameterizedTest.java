...
public class ActionProcessorAddRemoveParameterizedTest
    extends BaseActionProcessorParameterizedTest {

    public ActionProcessorAddRemoveParameterizedTest(
    ...
    public void shouldProcessAddRemoveActionBothWithDataChangeFlag() {
        ...
        changesToProcess = prepareChangesToProcess(
            Arrays.asList(ADD_ACTION_DATA_CHANGE, REMOVE_ACTION_DATA_CHANGE));
    ...
    @Test
    public void shouldProcessAddRemoveBothWithNoDataChangeFlag() {
        processor = new ActionProcessor(ignoreChanges, ignoreDeletes);
        boolean gotDeltaException = false;

        // GIVEN dataChangeFlag == false;
        changesToProcess = prepareChangesToProcess(
            Arrays.asList(ADD_ACTION_NO_DATA_CHANGE, REMOVE_ACTION_NO_DATA_CHANGE));
