...
public class RowDataFormat implements DeltaBulkFormat<RowData> {
    ...
    @Override
    public Reader<RowData> createReader(org.apache.flink.configuration.Configuration configuration,
    ...
    @Override
    public Reader<RowData> restoreReader(org.apache.flink.configuration.Configuration configuration,
        DeltaSourceSplit deltaSourceSplit) throws IOException {
