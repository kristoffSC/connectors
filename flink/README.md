...
- For Azure Bloob Storage, the current version only supports reading. Writing to Azure Bloob Storage is not supported by Flink due to [issue](https://issues.apache.org/jira/browse/FLINK-17444) with class shading
